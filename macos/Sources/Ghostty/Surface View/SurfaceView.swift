...
extension Ghostty {
    ...
    struct SurfaceSearchOverlay: View {
        ...
        private func searchBar(in geo: GeometryProxy) -> some View {
            HStack(spacing: 4) {
                searchField
                searchNextButton
            ...
            .background(barSizeReader)
            .padding(padding)
            .offset(dragOffset)
            .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: corner.alignment)
            .gesture(searchBarDragGesture(in: geo))
        }
        ...
        @ViewBuilder
        private var searchFieldStatus: some View {
        ...
        private var searchNextButton: some View {
            Button(action: {
                _ = surfaceView.navigateSearchToNext()
            }, label: {
        ...
        private var searchPreviousButton: some View {
            Button(action: {
        ...
        private var barSizeReader: some View {
        ...
        private func searchBarDragGesture(in geo: GeometryProxy) -> some Gesture {
            DragGesture()
                .onChanged { value in
