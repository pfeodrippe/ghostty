...
check_failed_assoc_preserves_current_probe() {
  ...
  if grep -Fq "run Ghostty app failure" <<<"$output"; then
    echo "error: malformed assoc crashed Ghostty hot runtime" >&2
    echo "$output" >&2
    exit 1
  fi
  output="$(zig_hot eval-zig "$file" "$expr" 2>&1)"
...
check_missing_return_assoc_preserves_current_probe() {
  ...
  if grep -Fq "run Ghostty app failure" <<<"$output"; then
    echo "error: missing-return assoc crashed Ghostty hot runtime" >&2
    echo "$output" >&2
    exit 1
  fi
  output="$(zig_hot eval-zig "$file" "$expr" 2>&1)"
...
check_nonexistent_assoc_preserves_probe() {
  ...
  if grep -Fq "run Ghostty app failure" <<<"$output"; then
    echo "error: non-existent assoc crashed Ghostty hot runtime" >&2
    echo "$output" >&2
    exit 1
  fi
  output="$(zig_hot eval-zig "$file" "$expr" 2>&1)"
...
ghostty_type_info_integer_bits_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_integer_bits_score(3)' 2>&1)"
expect_hot_success "$ghostty_type_info_integer_bits_baseline"
expect_contains "$ghostty_type_info_integer_bits_baseline" "value: 11"
ghostty_type_info_integer_bits_assoc="$(zig_hot assoc --no-native type_info_integer_bits_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_integer_bits_score(seed: i64) i64 { return seed + 190; }' 2>&1)"
expect_hot_success "$ghostty_type_info_integer_bits_assoc"
ghostty_type_info_integer_bits_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_integer_bits_score(3)' 2>&1)"
expect_hot_success "$ghostty_type_info_integer_bits_patched"
expect_contains "$ghostty_type_info_integer_bits_patched" "value: 193"
ghostty_type_info_integer_bits_dissoc="$(zig_hot dissoc type_info_integer_bits_score 2>&1)"
expect_hot_success "$ghostty_type_info_integer_bits_dissoc"
ghostty_type_info_integer_bits_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_integer_bits_score(3)' 2>&1)"
expect_hot_success "$ghostty_type_info_integer_bits_restored"
expect_contains "$ghostty_type_info_integer_bits_restored" "value: 11"
echo "assoc/dissoc typeInfo integer bits function: OK"

ghostty_type_info_alias_bits_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_alias_bits_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_alias_bits_baseline"
expect_contains "$ghostty_type_info_alias_bits_baseline" "value: 58"
ghostty_type_info_alias_bits_assoc="$(zig_hot assoc --no-native type_info_alias_bits_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_alias_bits_score(seed: i64) i64 { return seed + 200; }' 2>&1)"
expect_hot_success "$ghostty_type_info_alias_bits_assoc"
ghostty_type_info_alias_bits_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_alias_bits_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_alias_bits_patched"
expect_contains "$ghostty_type_info_alias_bits_patched" "value: 201"
ghostty_type_info_alias_bits_dissoc="$(zig_hot dissoc type_info_alias_bits_score 2>&1)"
expect_hot_success "$ghostty_type_info_alias_bits_dissoc"
ghostty_type_info_alias_bits_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_alias_bits_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_alias_bits_restored"
expect_contains "$ghostty_type_info_alias_bits_restored" "value: 58"
echo "assoc/dissoc typeInfo alias bits function: OK"

ghostty_type_info_array_len_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_array_len_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_array_len_baseline"
expect_contains "$ghostty_type_info_array_len_baseline" "value: 257"
ghostty_type_info_array_len_assoc="$(zig_hot assoc --no-native type_info_array_len_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_array_len_score(seed: i64) i64 { return seed + 2560; }' 2>&1)"
expect_hot_success "$ghostty_type_info_array_len_assoc"
ghostty_type_info_array_len_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_array_len_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_array_len_patched"
expect_contains "$ghostty_type_info_array_len_patched" "value: 2561"
ghostty_type_info_array_len_dissoc="$(zig_hot dissoc type_info_array_len_score 2>&1)"
expect_hot_success "$ghostty_type_info_array_len_dissoc"
ghostty_type_info_array_len_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_array_len_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_array_len_restored"
expect_contains "$ghostty_type_info_array_len_restored" "value: 257"
echo "assoc/dissoc typeInfo array len function: OK"

ghostty_type_info_if_tag_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_if_tag_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_if_tag_baseline"
expect_contains "$ghostty_type_info_if_tag_baseline" "value: 13"
ghostty_type_info_if_tag_assoc="$(zig_hot assoc --no-native type_info_if_tag_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_if_tag_score(seed: i64) i64 { return seed + 205; }' 2>&1)"
expect_hot_success "$ghostty_type_info_if_tag_assoc"
ghostty_type_info_if_tag_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_if_tag_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_if_tag_patched"
expect_contains "$ghostty_type_info_if_tag_patched" "value: 206"
ghostty_type_info_if_tag_dissoc="$(zig_hot dissoc type_info_if_tag_score 2>&1)"
expect_hot_success "$ghostty_type_info_if_tag_dissoc"
ghostty_type_info_if_tag_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_if_tag_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_if_tag_restored"
expect_contains "$ghostty_type_info_if_tag_restored" "value: 13"
echo "assoc/dissoc typeInfo if-tag function: OK"

ghostty_type_info_fields_index_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_fields_index_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_fields_index_baseline"
expect_contains "$ghostty_type_info_fields_index_baseline" "value: 15"
ghostty_type_info_fields_index_assoc="$(zig_hot assoc --no-native type_info_fields_index_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_fields_index_score(seed: i64) i64 { const fields = @typeInfo(FieldEnum).@"enum".fields; var total = seed; inline for (fields, 0..) |field, index| { total += field.value * @as(i64, @intCast(index + 10)); } return total; }' 2>&1)"
expect_hot_success "$ghostty_type_info_fields_index_assoc"
ghostty_type_info_fields_index_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_fields_index_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_fields_index_patched"
expect_contains "$ghostty_type_info_fields_index_patched" "value: 69"
ghostty_type_info_fields_index_dissoc="$(zig_hot dissoc type_info_fields_index_score 2>&1)"
expect_hot_success "$ghostty_type_info_fields_index_dissoc"
ghostty_type_info_fields_index_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_fields_index_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_fields_index_restored"
expect_contains "$ghostty_type_info_fields_index_restored" "value: 15"
echo "assoc/dissoc typeInfo fields index function: OK"

ghostty_type_info_enum_count_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_count_score(10)' 2>&1)"
expect_hot_success "$ghostty_type_info_enum_count_baseline"
expect_contains "$ghostty_type_info_enum_count_baseline" "value: 13"
ghostty_type_info_enum_count_assoc="$(zig_hot assoc --no-native type_info_enum_count_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_enum_count_score(seed: i64) i64 { return seed + 230; }' 2>&1)"
expect_hot_success "$ghostty_type_info_enum_count_assoc"
ghostty_type_info_enum_count_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_count_score(10)' 2>&1)"
expect_hot_success "$ghostty_type_info_enum_count_patched"
expect_contains "$ghostty_type_info_enum_count_patched" "value: 240"
ghostty_type_info_enum_count_dissoc="$(zig_hot dissoc type_info_enum_count_score 2>&1)"
expect_hot_success "$ghostty_type_info_enum_count_dissoc"
ghostty_type_info_enum_count_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_count_score(10)' 2>&1)"
expect_hot_success "$ghostty_type_info_enum_count_restored"
expect_contains "$ghostty_type_info_enum_count_restored" "value: 13"
echo "assoc/dissoc typeInfo enum count function: OK"

ghostty_type_info_enum_index_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_index_score(.b)' 2>&1)"
expect_hot_success "$ghostty_type_info_enum_index_baseline"
expect_contains "$ghostty_type_info_enum_index_baseline" "value: 1"
ghostty_type_info_enum_index_assoc="$(zig_hot assoc --no-native type_info_enum_index_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_enum_index_score(tag: FieldEnum) i64 { return @intFromEnum(tag) + 10; }' 2>&1)"
expect_hot_success "$ghostty_type_info_enum_index_assoc"
ghostty_type_info_enum_index_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_index_score(.b)' 2>&1)"
expect_hot_success "$ghostty_type_info_enum_index_patched"
expect_contains "$ghostty_type_info_enum_index_patched" "value: 12"
ghostty_type_info_enum_index_dissoc="$(zig_hot dissoc type_info_enum_index_score 2>&1)"
expect_hot_success "$ghostty_type_info_enum_index_dissoc"
ghostty_type_info_enum_index_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_index_score(.b)' 2>&1)"
expect_hot_success "$ghostty_type_info_enum_index_restored"
expect_contains "$ghostty_type_info_enum_index_restored" "value: 1"
echo "assoc/dissoc typeInfo enum index function: OK"

ghostty_type_of_if_condition_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_if_condition_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_of_if_condition_baseline"
expect_contains "$ghostty_type_of_if_condition_baseline" "value: 32"
ghostty_type_of_if_condition_assoc="$(zig_hot assoc --no-native type_of_if_condition_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_of_if_condition_score(seed: i64) i64 { return seed + 310; }' 2>&1)"
expect_hot_success "$ghostty_type_of_if_condition_assoc"
ghostty_type_of_if_condition_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_if_condition_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_of_if_condition_patched"
expect_contains "$ghostty_type_of_if_condition_patched" "value: 311"
ghostty_type_of_if_condition_dissoc="$(zig_hot dissoc type_of_if_condition_score 2>&1)"
expect_hot_success "$ghostty_type_of_if_condition_dissoc"
ghostty_type_of_if_condition_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_if_condition_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_of_if_condition_restored"
expect_contains "$ghostty_type_of_if_condition_restored" "value: 32"
echo "assoc/dissoc TypeOf if-condition function: OK"

ghostty_type_of_var_type_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_var_type_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_of_var_type_baseline"
expect_contains "$ghostty_type_of_var_type_baseline" "value: 33"
ghostty_type_of_var_type_assoc="$(zig_hot assoc --no-native type_of_var_type_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_of_var_type_score(seed: i64) i64 { return seed + 320; }' 2>&1)"
expect_hot_success "$ghostty_type_of_var_type_assoc"
ghostty_type_of_var_type_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_var_type_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_of_var_type_patched"
expect_contains "$ghostty_type_of_var_type_patched" "value: 321"
ghostty_type_of_var_type_dissoc="$(zig_hot dissoc type_of_var_type_score 2>&1)"
expect_hot_success "$ghostty_type_of_var_type_dissoc"
ghostty_type_of_var_type_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_var_type_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_of_var_type_restored"
expect_contains "$ghostty_type_of_var_type_restored" "value: 33"
echo "assoc/dissoc TypeOf var-type function: OK"


ghostty_type_info_pointer_optional_array_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_pointer_optional_array_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_pointer_optional_array_baseline"
expect_contains "$ghostty_type_info_pointer_optional_array_baseline" "value: 65"
ghostty_type_info_pointer_optional_array_assoc="$(zig_hot assoc --no-native type_info_pointer_optional_array_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_pointer_optional_array_score(seed: i64) i64 { return seed + 260; }' 2>&1)"
expect_hot_success "$ghostty_type_info_pointer_optional_array_assoc"
ghostty_type_info_pointer_optional_array_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_pointer_optional_array_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_pointer_optional_array_patched"
expect_contains "$ghostty_type_info_pointer_optional_array_patched" "value: 261"
ghostty_type_info_pointer_optional_array_dissoc="$(zig_hot dissoc type_info_pointer_optional_array_score 2>&1)"
expect_hot_success "$ghostty_type_info_pointer_optional_array_dissoc"
ghostty_type_info_pointer_optional_array_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_pointer_optional_array_score(1)' 2>&1)"
expect_hot_success "$ghostty_type_info_pointer_optional_array_restored"
expect_contains "$ghostty_type_info_pointer_optional_array_restored" "value: 65"
echo "assoc/dissoc typeInfo pointer/optional/array metadata function: OK"

ghostty_type_info_struct_layout_tuple_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_struct_layout_tuple_score(10)' 2>&1)"
expect_hot_success "$ghostty_type_info_struct_layout_tuple_baseline"
expect_contains "$ghostty_type_info_struct_layout_tuple_baseline" "value: 25"
ghostty_type_info_struct_layout_tuple_assoc="$(zig_hot assoc --no-native type_info_struct_layout_tuple_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_struct_layout_tuple_score(seed: i64) i64 { return seed + 270; }' 2>&1)"
expect_hot_success "$ghostty_type_info_struct_layout_tuple_assoc"
ghostty_type_info_struct_layout_tuple_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_struct_layout_tuple_score(10)' 2>&1)"
expect_hot_success "$ghostty_type_info_struct_layout_tuple_patched"
expect_contains "$ghostty_type_info_struct_layout_tuple_patched" "value: 280"
ghostty_type_info_struct_layout_tuple_dissoc="$(zig_hot dissoc type_info_struct_layout_tuple_score 2>&1)"
expect_hot_success "$ghostty_type_info_struct_layout_tuple_dissoc"
ghostty_type_info_struct_layout_tuple_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_struct_layout_tuple_score(10)' 2>&1)"
expect_hot_success "$ghostty_type_info_struct_layout_tuple_restored"
expect_contains "$ghostty_type_info_struct_layout_tuple_restored" "value: 25"
echo "assoc/dissoc typeInfo struct layout/tuple metadata function: OK"

ghostty_compile_error_guard_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'compile_error_guard_score(1)' 2>&1)"
expect_hot_success "$ghostty_compile_error_guard_baseline"
expect_contains "$ghostty_compile_error_guard_baseline" "value: 10"
ghostty_compile_error_guard_assoc="$(zig_hot assoc --no-native compile_error_guard_score --file test/hot/local_pointer_alias_probe.zig 'pub fn compile_error_guard_score(seed: i64) i64 { return seed + 210; }' 2>&1)"
expect_hot_success "$ghostty_compile_error_guard_assoc"
ghostty_compile_error_guard_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'compile_error_guard_score(1)' 2>&1)"
expect_hot_success "$ghostty_compile_error_guard_patched"
expect_contains "$ghostty_compile_error_guard_patched" "value: 211"
ghostty_compile_error_guard_dissoc="$(zig_hot dissoc compile_error_guard_score 2>&1)"
expect_hot_success "$ghostty_compile_error_guard_dissoc"
ghostty_compile_error_guard_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'compile_error_guard_score(1)' 2>&1)"
expect_hot_success "$ghostty_compile_error_guard_restored"
expect_contains "$ghostty_compile_error_guard_restored" "value: 10"
echo "assoc/dissoc compile-error reflection guard function: OK"

ghostty_catch_pointer_alias_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'catch_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$ghostty_catch_pointer_alias_baseline"
expect_contains "$ghostty_catch_pointer_alias_baseline" "value: 15"
ghostty_catch_pointer_alias_assoc="$(zig_hot assoc --no-native catch_pointer_alias_score --file test/hot/local_pointer_alias_probe.zig 'pub fn catch_pointer_alias_score(seed: i64) i64 { return seed + 215; }' 2>&1)"
expect_hot_success "$ghostty_catch_pointer_alias_assoc"
ghostty_catch_pointer_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'catch_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$ghostty_catch_pointer_alias_patched"
expect_contains "$ghostty_catch_pointer_alias_patched" "value: 216"
ghostty_catch_pointer_alias_dissoc="$(zig_hot dissoc catch_pointer_alias_score 2>&1)"
expect_hot_success "$ghostty_catch_pointer_alias_dissoc"
ghostty_catch_pointer_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'catch_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$ghostty_catch_pointer_alias_restored"
expect_contains "$ghostty_catch_pointer_alias_restored" "value: 15"
echo "assoc/dissoc catch pointer-alias function: OK"

ghostty_orelse_pointer_alias_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'orelse_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$ghostty_orelse_pointer_alias_baseline"
expect_contains "$ghostty_orelse_pointer_alias_baseline" "value: 17"
ghostty_orelse_pointer_alias_assoc="$(zig_hot assoc --no-native orelse_pointer_alias_score --file test/hot/local_pointer_alias_probe.zig 'pub fn orelse_pointer_alias_score(seed: i64) i64 { return seed + 216; }' 2>&1)"
expect_hot_success "$ghostty_orelse_pointer_alias_assoc"
ghostty_orelse_pointer_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'orelse_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$ghostty_orelse_pointer_alias_patched"
expect_contains "$ghostty_orelse_pointer_alias_patched" "value: 217"
ghostty_orelse_pointer_alias_dissoc="$(zig_hot dissoc orelse_pointer_alias_score 2>&1)"
expect_hot_success "$ghostty_orelse_pointer_alias_dissoc"
ghostty_orelse_pointer_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'orelse_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$ghostty_orelse_pointer_alias_restored"
expect_contains "$ghostty_orelse_pointer_alias_restored" "value: 17"
echo "assoc/dissoc orelse pointer-alias function: OK"

ghostty_optional_pointer_payload_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'optional_pointer_payload_score(1)' 2>&1)"
expect_hot_success "$ghostty_optional_pointer_payload_baseline"
expect_contains "$ghostty_optional_pointer_payload_baseline" "value: 19"
ghostty_optional_pointer_payload_assoc="$(zig_hot assoc --no-native optional_pointer_payload_score --file test/hot/local_pointer_alias_probe.zig 'pub fn optional_pointer_payload_score(seed: i64) i64 { return seed + 218; }' 2>&1)"
expect_hot_success "$ghostty_optional_pointer_payload_assoc"
ghostty_optional_pointer_payload_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'optional_pointer_payload_score(1)' 2>&1)"
expect_hot_success "$ghostty_optional_pointer_payload_patched"
expect_contains "$ghostty_optional_pointer_payload_patched" "value: 219"
ghostty_optional_pointer_payload_dissoc="$(zig_hot dissoc optional_pointer_payload_score 2>&1)"
expect_hot_success "$ghostty_optional_pointer_payload_dissoc"
ghostty_optional_pointer_payload_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'optional_pointer_payload_score(1)' 2>&1)"
expect_hot_success "$ghostty_optional_pointer_payload_restored"
expect_contains "$ghostty_optional_pointer_payload_restored" "value: 19"
echo "assoc/dissoc optional pointer-payload function: OK"

ghostty_zipped_pointer_capture_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'zipped_pointer_capture_score(1)' 2>&1)"
expect_hot_success "$ghostty_zipped_pointer_capture_baseline"
expect_contains "$ghostty_zipped_pointer_capture_baseline" "value: 12454"
ghostty_zipped_pointer_capture_assoc="$(zig_hot assoc --no-native zipped_pointer_capture_score --file test/hot/local_pointer_alias_probe.zig 'pub fn zipped_pointer_capture_score(seed: i64) i64 { return seed + 220; }' 2>&1)"
expect_hot_success "$ghostty_zipped_pointer_capture_assoc"
ghostty_zipped_pointer_capture_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'zipped_pointer_capture_score(1)' 2>&1)"
expect_hot_success "$ghostty_zipped_pointer_capture_patched"
expect_contains "$ghostty_zipped_pointer_capture_patched" "value: 221"
ghostty_zipped_pointer_capture_dissoc="$(zig_hot dissoc zipped_pointer_capture_score 2>&1)"
expect_hot_success "$ghostty_zipped_pointer_capture_dissoc"
ghostty_zipped_pointer_capture_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'zipped_pointer_capture_score(1)' 2>&1)"
expect_hot_success "$ghostty_zipped_pointer_capture_restored"
expect_contains "$ghostty_zipped_pointer_capture_restored" "value: 12454"
echo "assoc/dissoc zipped pointer-capture function: OK"

ghostty_labeled_block_pointer_alias_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$ghostty_labeled_block_pointer_alias_baseline"
expect_contains "$ghostty_labeled_block_pointer_alias_baseline" "value: 23"
ghostty_labeled_block_pointer_alias_assoc="$(zig_hot assoc --no-native labeled_block_pointer_alias_score --file test/hot/local_pointer_alias_probe.zig 'pub fn labeled_block_pointer_alias_score(seed: i64) i64 { var value = seed; const ptr = block: { break :block &value; }; ptr.* += 222; return value; }' 2>&1)"
expect_hot_success "$ghostty_labeled_block_pointer_alias_assoc"
ghostty_labeled_block_pointer_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$ghostty_labeled_block_pointer_alias_patched"
expect_contains "$ghostty_labeled_block_pointer_alias_patched" "value: 223"
ghostty_labeled_block_pointer_alias_dissoc="$(zig_hot dissoc labeled_block_pointer_alias_score 2>&1)"
expect_hot_success "$ghostty_labeled_block_pointer_alias_dissoc"
ghostty_labeled_block_pointer_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$ghostty_labeled_block_pointer_alias_restored"
expect_contains "$ghostty_labeled_block_pointer_alias_restored" "value: 23"
echo "assoc/dissoc labeled-block pointer-alias function: OK"

ghostty_labeled_block_struct_store_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_struct_store_score(3)' 2>&1)"
expect_hot_success "$ghostty_labeled_block_struct_store_baseline"
expect_contains "$ghostty_labeled_block_struct_store_baseline" "value: 43"
ghostty_labeled_block_struct_store_assoc="$(zig_hot assoc --no-native labeled_block_struct_store_score --file test/hot/local_pointer_alias_probe.zig 'pub fn labeled_block_struct_store_score(seed: i64) i64 { var filters: [1]Filter = .{.{ .min = 0, .max = 0 }}; const filter: *Filter = block: { break :block &filters[0]; }; filter.* = .{ .min = seed + 20, .max = seed + 30 }; return filters[0].min * 10 + filters[0].max; }' 2>&1)"
expect_hot_success "$ghostty_labeled_block_struct_store_assoc"
ghostty_labeled_block_struct_store_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_struct_store_score(3)' 2>&1)"
expect_hot_success "$ghostty_labeled_block_struct_store_patched"
expect_contains "$ghostty_labeled_block_struct_store_patched" "value: 263"
ghostty_labeled_block_struct_store_dissoc="$(zig_hot dissoc labeled_block_struct_store_score 2>&1)"
expect_hot_success "$ghostty_labeled_block_struct_store_dissoc"
ghostty_labeled_block_struct_store_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_struct_store_score(3)' 2>&1)"
expect_hot_success "$ghostty_labeled_block_struct_store_restored"
expect_contains "$ghostty_labeled_block_struct_store_restored" "value: 43"
echo "assoc/dissoc labeled-block struct-store function: OK"
