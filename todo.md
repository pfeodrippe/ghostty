...
- [ ] tools are clojure functions
  - [ ] add to context if derived keyword
- [ ] registerFunction for java
- [ ] embedded nrepl
  - in yolo mode
- [ ] use sci to add new tools
- [ ] rewrite flecs in java
- [ ] zig agent using flecs to have replaceable agents
  - uses flecs as the runtime
  - ability to swap code (hot reloading)
- [ ] we can override compaction per project
